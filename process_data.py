...
##########################################
# Extract CS courses (JSON objects loaded
...
print(f"Data parsing complete. Total passages created: {len(data)}")

##########################################
# Save data to a file for easy viewing
##########################################
with open("./data/cs_with_sources.txt", "w") as f:
    for passage, source in data:
...
##########################################
with open("./db_cs_with_sources.pkl", "wb") as f:
    pickle.dump(db, f)
